...
If you see `ModuleNotFoundError: No module named 'google.genai'`, it means the required SDK is missing. In restricted environments, use **`uv`** to install it:
```bash
uv pip install google-adk==1.2.1
```
